...
import 'package:fuodz/view_models/driver_application.view_model.dart';
import 'package:fuodz/widgets/base.page.dart';
import 'package:fuodz/widgets/buttons/custom_button.dart';
import 'package:fuodz/widgets/cards/driver_document_upload.view.dart';
import 'package:localize_and_translate/localize_and_translate.dart';
import 'package:stacked/stacked.dart';
import 'package:velocity_x/velocity_x.dart';
import 'package:fuodz/extensions/context.dart';

class DriverApplicationPage extends StatelessWidget {
  const DriverApplicationPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<DriverApplicationViewModel>.reactive(
      viewModelBuilder: () => DriverApplicationViewModel(context),
      onViewModelReady: (vm) => vm.initialise(),
      builder: (context, vm, child) {
        return BasePage(
          showAppBar: true,
          showLeadingAction: true,
          title: "Driver Application".tr(),
          isLoading: vm.isBusy,
          body: VStack(
            [
              // Header Section
              ...
              ...DocumentType.requiredDocuments.map(
                (docType) => DriverDocumentUploadView(
              ...
              UiSpacer.vSpace(12),
              ...DocumentType.optionalDocuments.map(
                (docType) => DriverDocumentUploadView(
                  documentType: docType,
                  onDocumentSelected: (document) =>
                      vm.onDocumentUpdated(docType, document),
  ...
  Widget _buildHeaderSection(BuildContext context, DriverApplicationViewModel vm) {
    return VStack(
      [
        Icon(
        ...
        "Complete Your Application"
            ...
            .make(),
        UiSpacer.vSpace(8),
        "Upload your verification documents to become a verified driver"
            .tr()
            .text
            .center
            .gray600
  ...
  Widget _buildProgressIndicator(
      BuildContext context, DriverApplicationViewModel vm) {
    ...
    return VStack(
      [
        ...
        UiSpacer.vSpace(4),
        "${vm.uploadedRequiredDocuments} of ${DocumentType.requiredDocuments.length} required documents uploaded"
            .tr()
            .text
            .sm
            .gray600
