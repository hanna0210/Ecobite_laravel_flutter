...
class DriverDocumentUploadView extends StatefulWidget {
  const DriverDocumentUploadView({
    Key? key,
  ...
  final Function(DriverDocument?) onDocumentSelected;
  final DriverDocument? initialDocument;
  final bool isRequired;

  @override
  State<DriverDocumentUploadView> createState() =>
      _DriverDocumentUploadViewState();
}

class _DriverDocumentUploadViewState extends State<DriverDocumentUploadView> {
  final _formKey = GlobalKey<FormBuilderState>();
  DriverDocument? currentDocument;
  bool hasFile = false;
  ...
  void initState() {
    ...
    currentDocument = widget.initialDocument ??
        DriverDocument(documentType: widget.documentType);
          ...
          if (hasFile) ...[
            ...
            FormBuilderTextField(
              ...
              decoration: inputDec.copyWith(
                ...
                hintText: "e.g., Department of Transportation".tr(),
  ...
  bool _hasExpiryDate() {
    return widget.documentType == DocumentType.driverLicense ||
        widget.documentType == DocumentType.vehicleInsurance ||
        widget.documentType == DocumentType.nationalId;
  }
