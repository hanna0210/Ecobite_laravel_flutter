...
import 'package:fuodz/views/pages/auth/driver_application.page.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case AppRoutes.driverApplicationRoute:
      return MaterialPageRoute(
        settings: RouteSettings(name: AppRoutes.driverApplicationRoute),
        builder: (context) => DriverApplicationPage(),
      );
