...
import 'package:fuodz/views/pages/auth/otp_verification.page.dart';
...
///////
  ...
  // Handle device login after social media registration/login
  handleDeviceLogin(ApiResponse apiResponse) async {
    try {
      ...
      AlertService.error(
        title: ("FirebaseAuthException " + "Registration Failed".tr()),
        text: "${error.message}",
      );
    } catch (error) {
      AlertService.error(
  ...
  // Social Login Methods for Registration
  void processGoogleLogin() async {
    socialMediaLoginService.googleLogin(this as dynamic);
  }

  void processFacebookLogin() async {
    socialMediaLoginService.facebookLogin(this as dynamic);
  }

  void processAppleLogin() async {
    socialMediaLoginService.appleLogin(this as dynamic);
  }
}
